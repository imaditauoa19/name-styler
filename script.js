...
const fonts = {
  ...
  // خط مقلوب رأساً على عقب
    upsideDown: {'a':'ɐ','b':'q','c':'ɔ','d':'p','e':'ǝ','f':'ɟ','g':'ƃ','h':'ɥ','i':'ᴉ','j':'ɾ','k':'ʞ','l':'l','m':'ɯ','n':'u','o':'o','p':'d','q':'b','r':'ɹ','s':'s','t':'ʇ','u':'n','v':'ʌ','w':'ʍ','x':'x','y':'ʎ','z':'z','A':'∀','B':'𐐒','C':'Ɔ','D':'◖','E':'Ǝ','F':'Ⅎ','G':'פ','H':'H','I':'I','J':'ɾ','K':'ʞ','L':'˥','M':'W','N':'N','O':'O','P':'Ԁ','Q':'Q','R':'ᴚ','S':'S','T':'┴','U':'∩','V':'Λ','W':'M','X':'X','Y':'⅄','Z':'Z'},

    // خط مرايا (معكوس)
    mirror: {'a':'ɒ','b':'d','c':'ɔ','d':'b','e':'ɘ','f':'ʇ','g':'ϱ','h':'ʜ','i':'i','j':'ꞁ','k':'ʞ','l':'l','m':'m','n':'ᴎ','o':'o','p':'q','q':'p','r':'ɿ','s':'ƨ','t':'ƚ','u':'u','v':'v','w':'w','x':'x','y':'y','z':'z','A':'A','B':'ᗺ','C':'Ɔ','D':'ᗡ','E':'Ǝ','F':'ꟻ','G':'Ꮹ','H':'H','I':'I','J':'Ꞁ','K':'ꓘ','L':'⅃','M':'M','N':'ᴎ','O':'O','P':'ꟼ','Q':'Ọ','R':'Я','S':'Ƨ','T':'T','U':'U','V':'V','W':'W','X':'X','Y':'Y','Z':'Z'},
...
const ffBios = [
   ...
   { name: "علم سوريا", code: "[b][ff0000]███\n[ffffff]★ ★\n[000000]███" },
    ...
    { name: "علم العراق", code: "[b][cc0001]███\n[ffffff]★ ★ ★\n[000000]███" },
    { name: "علم الكويت", code: "[b][007a3d]███\n[ffffff]█[ce1126]█[ffffff]█\n[007a3d]███" },
    { name: "علم قطر", code: "[b][8d1b3d]████[ffffff]███" },
    { name: "علم عُمان", code: "[b][db161b]███[ffffff]█[008000]███" },
    { name: "علم اليمن", code: "[b][ce1126]███\n[ffffff]███\n[000000]███" },
    { name: "Booyah", code: "[b][c][ffd700]🏆 B O O Y A H 🏆\n[ffffff]─────────────" },
    { name: "MVP", code: "[b][c][ffd700]★ M V P ★\n[ff0000]─[ TOP PLAYER ]─" },
    { name: "هجوم", code: "[b][c][ff0000]⚔️ A T T A C K ⚔️\n[ffffff]── RUSH ──" },
    { name: "دفاع", code: "[b][c][0000ff]🛡️ D E F E N D\n[ffffff]── HOLD ──" },
    { name: "قناص محترف", code: "[b][c][00ff00]🎯 S N I P E R\n[808080]▂▃▄▅▆▇█ 100%" },
    { name: "غامر محترف", code: "[b][c][ffd700]👑 P R O\n[00ffff]── G A M E R ──" },
...
// أكواد الألوان
const ffColors = [
    { name: "أحمر", code: "[FF0000]", bg: "#FF0000" },
    { name: "أخضر", code: "[00FF00]", bg: "#00FF00" },
    { name: "أزرق", code: "[0000FF]", bg: "#0000FF" },
    { name: "أصفر", code: "[FFFF00]", bg: "#FFFF00" },
    { name: "أبيض", code: "[FFFFFF]", bg: "#FFFFFF" },
    { name: "أسود", code: "[000000]", bg: "#000000" },
    { name: "ذهبي", code: "[FFD700]", bg: "#FFD700" },
    { name: "بنفسجي", code: "[FF00FF]", bg: "#FF00FF" },
    { name: "وردي", code: "[FF1493]", bg: "#FF1493" },
    { name: "برتقالي", code: "[FF8C00]", bg: "#FF8C00" },
    { name: "رمادي", code: "[808080]", bg: "#808080" },
    { name: "سماوي", code: "[00FFFF]", bg: "#00FFFF" },
    { name: "ليموني", code: "[ADFF2F]", bg: "#ADFF2F" },
    { name: "بنفسجي غامق", code: "[4B0082]", bg: "#4B0082" },
    { name: "بني", code: "[8B4513]", bg: "#8B4513" },
    { name: "عنابي", code: "[800000]", bg: "#800000" },
    { name: "كحلي", code: "[000080]", bg: "#000080" },
    { name: "أحمر فاتح", code: "[FF4444]", bg: "#FF4444" },
    { name: "أخضر فاتح", code: "[00FF7F]", bg: "#00FF7F" },
    { name: "أزرق سماوي", code: "[00BFFF]", bg: "#00BFFF" },
    { name: "بنفسجي فاتح", code: "[DA70D6]", bg: "#DA70D6" },
    { name: "وردي فاتح", code: "[FFB6C1]", bg: "#FFB6C1" },
    { name: "برتقالي فاتح", code: "[FFA500]", bg: "#FFA500" },
    { name: "أصفر ذهبي", code: "[FFD700]", bg: "#FFD700" },
    { name: "أخضر زيتي", code: "[6B8E23]", bg: "#6B8E23" },
    { name: "أزرق ملكي", code: "[4169E1]", bg: "#4169E1" },
    { name: "أحمر داكن", code: "[8B0000]", bg: "#8B0000" },
    { name: "أخضر داكن", code: "[006400]", bg: "#006400" },
    { name: "رمادي فاتح", code: "[D3D3D3]", bg: "#D3D3D3" },
    { name: "بني فاتح", code: "[D2691E]", bg: "#D2691E" },
    { name: "وردي صارخ", code: "[FF69B4]", bg: "#FF69B4" },
    { name: "أزرق فاتح", code: "[ADD8E6]", bg: "#ADD8E6" }
];

// الرموز الضخمة
const ffSymbols = [
      // فراغات خاصة مقبولة في الألعاب
    ' ','ㅤ','　','᳀',
    '亗', '♛', '♚', '★', '✪', '✧', '✦', '☽', '☾', '♕', '♔', 'ꄍ', 'Ⓥ', '★—͟͞͞', '⚜',
...
function generateAllDecorations() {
    ...
    // ==========================================
        ...
        allDecorations.push({ type: 'en', text: applyFont(input, fonts.upsideDown) });
        allDecorations.push({ type: 'en', text: applyFont(input, fonts.mirror) });
        allDecorations.push({ type: 'en', text: applyFont(input, fonts.dots) });
